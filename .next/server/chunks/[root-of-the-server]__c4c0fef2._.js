...
"[project]/lib/supabase/supabase.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/supabase.ts [app-route] (ecmascript)");
;
;
async function GET(request) {
    ...
    if (code) {
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].auth.exchangeCodeForSession(code);
        if (!error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c4c0fef2._.js.map