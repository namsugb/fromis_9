...
function Chat(param) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$comments$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addComment"])(member, message, "");
            if (result) {
                setMessage("");
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: [
                        "로그인됨: ",
                        ((_user_email = user.email) === null || _user_email === void 0 ? void 0 : _user_email.split('@')[0]) || '사용자'
                    ]
                }, void 0, true, {
                    fileName: "[project]/components/common/chat.tsx",
                    lineNumber: 88,
...
_s(Chat, "eMw1dw+hlOix86QFdphL19oAxqw=", false, function() {
    return [
...
"[project]/app/heon/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "Heon.useEffect": ()=>{
            const addComment = {
                "Heon.useEffect.addComment": ()=>{
                    ...
                    setComments({
                        "Heon.useEffect.addComment": (prev)=>[
                                ...prev,
                                newComment
                            ]
                    }["Heon.useEffect.addComment"]);
                    ...
                    setTimeout({
                        "Heon.useEffect.addComment": ()=>{
                            setComments({
                                "Heon.useEffect.addComment": (prev)=>prev.filter({
                                        "Heon.useEffect.addComment": (comment)=>comment.id !== uniqueId
                                    }["Heon.useEffect.addComment"])
                            }["Heon.useEffect.addComment"]);
                        }
                    }["Heon.useEffect.addComment"], 5000);
                }
            }["Heon.useEffect.addComment"];
            // 1.5초마다 새 댓글 추가
            const interval = setInterval(addComment, 1500);
            return ({
                "Heon.useEffect": ()=>clearInterval(interval)
            })["Heon.useEffect"];
        }
    }["Heon.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Heon, "ByfV/t0DOiJY0nGyfgV+6QjIggQ=");
_c = Heon;
var _c;
__turbopack_context__.k.register(_c, "Heon");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_e1b263dd._.js.map