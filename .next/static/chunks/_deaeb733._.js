...
const subscribeToComments = (member, callback)=>{
    ...
    const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel("".concat(tableName, "_changes")).on('postgres_changes', {
        event: 'INSERT',
        schema: 'public',
        table: tableName
    }, (payload)=>{
...
;
function Chat(param) {
    let { member = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MEMBERS"].CHANG, onCommentAdded } = param;
    _s();
        ...
        "Hayeong.useEffect": ()=>{
            const addComment = {
                "Hayeong.useEffect.addComment": ()=>{
                    ...
                    setComments({
                        "Hayeong.useEffect.addComment": (prev)=>[
                                ...prev,
                                newComment
                            ]
                    }["Hayeong.useEffect.addComment"]);
                    ...
                    setTimeout({
                        "Hayeong.useEffect.addComment": ()=>{
                            setComments({
                                "Hayeong.useEffect.addComment": (prev)=>prev.filter({
                                        "Hayeong.useEffect.addComment": (comment)=>comment.id !== uniqueId
                                    }["Hayeong.useEffect.addComment"])
                            }["Hayeong.useEffect.addComment"]);
                        }
                    }["Hayeong.useEffect.addComment"], 5000);
                }
            }["Hayeong.useEffect.addComment"];
            // 1.5초마다 새 댓글 추가
            const interval = setInterval(addComment, 1500);
            return ({
                "Hayeong.useEffect": ()=>clearInterval(interval)
            })["Hayeong.useEffect"];
        }
    }["Hayeong.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Hayeong, "ByfV/t0DOiJY0nGyfgV+6QjIggQ=");
_c = Hayeong;
var _c;
__turbopack_context__.k.register(_c, "Hayeong");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_deaeb733._.js.map