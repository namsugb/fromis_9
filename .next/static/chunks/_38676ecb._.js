...
function FanComments() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FanComments.useEffect": ()=>{
            const addComment = {
                "FanComments.useEffect.addComment": ()=>{
                    ...
                    setComments({
                        "FanComments.useEffect.addComment": (prev)=>[
                                ...prev,
                                newComment
                            ]
                    }["FanComments.useEffect.addComment"]);
                    ...
                    setTimeout({
                        "FanComments.useEffect.addComment": ()=>{
                            setComments({
                                "FanComments.useEffect.addComment": (prev)=>prev.filter({
                                        "FanComments.useEffect.addComment": (comment)=>comment.id !== newComment.id
                                    }["FanComments.useEffect.addComment"])
                            }["FanComments.useEffect.addComment"]);
                        }
                    }["FanComments.useEffect.addComment"], 5000);
                }
            }["FanComments.useEffect.addComment"];
            // 1.5초마다 새 댓글 추가
...
_s(FanComments, "ByfV/t0DOiJY0nGyfgV+6QjIggQ=");
_c = FanComments;
var _c;
...
//# sourceMappingURL=_38676ecb._.js.map